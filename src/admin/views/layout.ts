...
export function layout(title: string, content: string, user?: UserInfo | null): string {
  ...
  const navigation = [
    ...
    ['/admin/pages/companies', 'Страница «Бизнес»'],
    ['/admin/pages/blog', 'Страница «Журнал»'],
    ['/admin/pages/shooting-request', 'Страница «Стать героем»'],
    ['/admin/pages/privacy-policy', 'Политика конфиденциальности'],
    ['/admin/pages/trademark', 'Страница «Товарный знак»'],
    ...
    ['/admin/trademark-requests', 'Товарный знак — обращения'],
