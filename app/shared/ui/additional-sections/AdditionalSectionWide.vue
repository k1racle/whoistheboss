    ...
    <div class="mx-auto grid w-[min(calc(100%_-_80px),1920px)] grid-cols-[minmax(0,60%)_minmax(0,40%)] items-stretch gap-10 max-lg:w-full max-lg:grid-cols-1">
      <div class="flex min-h-full flex-col items-start">
        <AutoFitText
          as="h2"
          :text="title"
          class="m-0 w-full font-display text-[80px] font-black uppercase leading-[80px] tracking-[-0.03em] text-text max-lg:text-[clamp(43px,10vw,74px)] max-lg:leading-[0.92]"
        >
          <span
        ...
        <NuxtImg
          ...
          loading="lazy"
          decoding="async"
          class="mt-12 aspect-video w-full object-cover lg:w-[90%]"
        />
      </div>
