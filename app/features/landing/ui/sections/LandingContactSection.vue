...
<template>
  ...
  >
    <div class="mx-auto flex min-h-[600px] w-full max-w-[1920px] flex-col justify-between gap-14 px-6 pb-12 pt-7 lg:min-h-[888px] lg:flex-row lg:items-stretch lg:gap-10 lg:px-10 lg:py-10">
      <LandingContactText
        :cta-title="ctaTitle"
      ...
      <LandingContactForm
        ...
        class="lg:self-start xl:self-stretch"
        :status="status"
        @submit="onSubmit"
      />
    </div>
