    ...
    <div class="mx-auto w-full max-w-[1920px]">
      ...
      <div class="mt-16 grid gap-2 lg:mt-28">
        <details
          ...
          class="group border border-border-strong bg-surface text-text transition-colors duration-200 hover:border-accent hover:bg-accent hover:text-text-on-accent focus-within:border-accent focus-within:bg-accent focus-within:text-text-on-accent open:border-accent open:bg-accent open:text-text-on-accent"
        >
