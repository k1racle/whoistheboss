...
const DEFAULT_STAGES: ShootingStageItem[] = [
  {
    ...
    description: 'На первом этапе мы знакомимся с героем, изучаем его историю и собираем материалы для будущего выпуска.',
  },
  {
    index: '02',
    title: 'Съемочный',
    ...
    description: 'Проводим съемку интервью, портретов и дополнительных материалов в согласованной локации.',
  },
  {
    index: '03',
    title: 'Создание',
    ...
    description: 'После съемок собираем историю, готовим тексты, фотографии и видео для публикации.',
  },
  {
    index: '04',
    title: 'Публикация',
    ...
    description: 'Готовый материал выходит на площадках проекта и получает поддержку в наших каналах.',
  },
]
...
const DEFAULT_FAQ: ShootingFaqItem[] = [
  {
    ...
    answer: 'Предприниматели, руководители и создатели проектов, которым есть что рассказать о своем пути, решениях и опыте.',
  },
  {
    question: 'Как проходит отбор?',
    answer: 'После заявки команда знакомится с вашей историей и связывается, чтобы обсудить формат и следующие шаги.',
  },
  {
    question: 'Сколько времени занимает участие?',
    answer: 'Срок зависит от формата материала. Все этапы и даты мы согласуем до начала работы.',
  },
]
